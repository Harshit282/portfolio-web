            ...
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">
                  I throw myself down the line and
                </p>
                <p className="p service__text p__color">
                  do what i love the most "CODE"
                </p>
                <p className="p service__text p__color">
                  --Python Based Software Dev--
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">
                  I have worked with Modern
                </p>
                <p className="p service__text p__color">
                  Databases like SQL, Firebase etc.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">
                  I recently went down the path of
                </p>
                <p className="p service__text p__color">
                  Web Development and realized
                </p>
                <p className="p service__text p__color">that i loved it.</p>
              </div>
            </div>
          </div>
        </div>
